...
if len(sys.argv) != 6:
	print('./submit_3pop_popGrowth_NaFixed.py ab_AbC_1M_2N 100 /shared/home/croux/scratch/morpho/bin_snp /shared/mfs/data/home/croux/scratch/morpho/bin/dev/config.yaml gof_RF/ABC')
	sys.exit()
...
commande = 'python2 {0}/priorgen_3pop_popGrowth_NaFixed.py {1} {2} {3} {4} {5} {7} {8} | java -jar {0}/msms.jar tbs {6} -s tbs -r tbs tbs -I 3 tbs tbs tbs 0 -n 1 tbs -en tbs 1 tbs -n 2 tbs -en tbs 2 tbs -n 3 tbs -en tbs 3 tbs -m 1 2 tbs -m 2 1 tbs -m 1 3 tbs -m 3 1 tbs -m 2 3 tbs -m 3 2 tbs -em tbs 1 2 tbs -em tbs 2 1 tbs -em tbs 1 3 tbs -em tbs 3 1 tbs -em tbs 2 3 tbs -em tbs 3 2 tbs -ej tbs 2 1 -en tbs 1 tbs -ej tbs 3 1 -eN tbs tbs | pypy {0}/mscalc_3pop.py'.format(binpath, AB_model, ABC_model, M_model, N_model, nMultilocusSim, nMultilocusSim*nLoci, config_yaml, analysis)
#print(commande)
os.system(commande)
