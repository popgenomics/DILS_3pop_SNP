...
#help += "\033[1;32;40m#Command line for ms: \033[0m\n\tmsnsam tbs 10000 -t tbs -r tbs tbs -I 3 tbs tbs tbs 0 -n 1 tbs -n 2 tbs -n 3 tbs -m 1 2 tbs -m 2 1 tbs -m 1 3 tbs -m 3 1 tbs -m 2 3 tbs -m 3 2 tbs -em tbs 1 2 tbs -em tbs 2 1 tbs -em tbs 1 3 tbs -em tbs 3 1 tbs -em tbs 2 3 tbs -em tbs 3 2 tbs -ej tbs 2 1 -en tbs 1 tbs -ej tbs 3 1 -eN tbs tbs\n"
help += "\033[1;32;40m#Command line for ms: \033[0m\n\tjava -jar msms.jar tbs 10000 -s tbs -r tbs tbs -I 3 tbs tbs tbs 0 -n 1 tbs -n 2 tbs -n 3 tbs -m 1 2 tbs -m 2 1 tbs -m 1 3 tbs -m 3 1 tbs -m 2 3 tbs -m 3 2 tbs -em tbs 1 2 tbs -em tbs 2 1 tbs -em tbs 1 3 tbs -em tbs 3 1 tbs -em tbs 2 3 tbs -em tbs 3 2 tbs -ej tbs 2 1 -en tbs 1 tbs -ej tbs 3 1 -eN tbs tbs\n"

help += "\t\033[1;32;40mExample: ./priorgen_3pop.py ab/AB abc/ABC 1M/2M 1N/2N 1000 gof\033[0m\n"

### last argument, 'gof', is the kind of analysis that can be:
###	ABC (parameters from prior)
###	gof_RF (parameters from the first posterior obtained by using Random Forest)
analysis = sys.argv[6]
...
if analysis == 'gof_RF':
	param_RF = {}
	posteriorFile = open('../posterior_RF.txt', 'r')
	...
	Tsmall_AB  = param_RF['Tsmall_AB']*nMultilocus
	Tsmall_ABC  = param_RF['Tsmall_ABC']*nMultilocus
...
priorfile = "N1\tN2\tN3\tNa_12\tNa\tshape_N_a\tshape_N_b\tTsplit_12\tTsplit\tTsmall_AB\tTsmall_ABC\tM12\tshape_M12_a\tshape_M12_b\tM21\tshape_M21_a\tshape_M21_b\tM13\tM31\tM23\tM32\tshape_M13_a\tshape_M13_b\n"
...
for sim in range(nMultilocus):
	...
	priorfile += "{0:.5f}\t{1:.5f}\t{2:.5f}\t{3:.5f}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}\t{12:.5f}\t{13:.5f}\t{14:.5f}\t{15:.5f}\t{16:.5f}\t{17:.5f}\t{18:.5f}\t{19:.5f}\t{20:.5f}\t{21:.5f}\t{22:.5f}\n".format(N1[sim], N2[sim], N3[sim], Na_12[sim], Na[sim], shape_N_a[sim], shape_N_b[sim], Tsplit_12[sim], Tsplit[sim], Tsmall_12[sim], Tsmall_13[sim], M12[sim], shape_M12_a[sim], shape_M12_b[sim], M21[sim], shape_M21_a[sim], shape_M21_b[sim], M13[sim], M31[sim], M23[sim], M32[sim], shape_M13_a[sim], shape_M13_b[sim])
	...
	for locus in range(nLoci):
		# msnsam tbs 10000 -t tbs -r tbs tbs -I 3 tbs tbs tbs 0 -n 1 tbs -n 2 tbs -n 3 tbs -m 1 2 tbs -m 2 1 tbs -m 1 3 tbs -m 3 1 tbs -m 2 3 tbs -m 3 2 tbs -em tbs 1 2 tbs -em tbs 2 1 tbs -em tbs 1 3 tbs -em tbs 3 1 tbs -em tbs 2 3 tbs -em tbs 3 2 tbs -ej tbs 2 1 -en tbs 1 tbs -ej tbs 3 1 -eN tbs tbs
		print('{0}\t{1:.5f}\t{2:.5f}\t{3}\t{4}\t{5}\t{6}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}\t{12:.5f}\t{13:.5f}\t{14:.5f}\t{15:.5f}\t{16:.5f}\t{17:.5f}\t{18:.5f}\t{19:.5f}\t{20:.5f}\t{21:.5f}\t{22:.5f}\t{23:.5f}\t{24:.5f}\t{25:.5f}\t{26:.5f}\t{27:.5f}\t{28:.5f}\t{29:.5f}\t{30:.5f}\t{31:.5f}\t{32:.5f}\t{33:.5f}'.format(nsam_tot[locus], nSNPs[locus], rho[locus], L[locus], nsamA[locus], nsamB[locus], nsamC[locus], N1_vec[locus], N2_vec[locus], N3_vec[locus], M12_current_vec[locus], M21_current_vec[locus], M13_current_vec[locus], M31_current_vec[locus], M23_current_vec[locus], M32_current_vec[locus], Tsmall_12[sim], M12_past_vec[locus], Tsmall_12[sim], M21_past_vec[locus], Tsmall_13[sim], M13_past_vec[locus], Tsmall_13[sim], M31_past_vec[locus], Tsmall_13[sim], M23_past_vec[locus], Tsmall_13[sim], M32_past_vec[locus], Tsplit_12[sim], Tsplit_12[sim], Na_12_vec[locus], Tsplit[sim], Tsplit[sim], Na_vec[locus]))
