...
if analysis == 'ABC':
	...
	Tsplit = [ Tsplit[i]/Na[i] for i in range(nMultilocus) ]
	...
	# rescale all parameters such as Na = 1
#	N1 = [ N1[i]/Na[i] for i in range(nMultilocus) ]
#	N2 = [ N2[i]/Na[i] for i in range(nMultilocus) ]
#	N3 = [ N3[i]/Na[i] for i in range(nMultilocus) ]
#	N1a = [ N1a[i]/Na[i] for i in range(nMultilocus) ]
#	N2a = [ N2a[i]/Na[i] for i in range(nMultilocus) ]
#	N3a = [ N3a[i]/Na[i] for i in range(nMultilocus) ]
#	Na_12 = [ Na_12[i]/Na[i] for i in range(nMultilocus) ]
	
#	Tsplit_12 = [ Tsplit_12[i]/Na[i] for i in range(nMultilocus) ]
#	Tdem_1 = [ Tdem_1[i]/Na[i] for i in range(nMultilocus) ]
#	Tdem_2 = [ Tdem_2[i]/Na[i] for i in range(nMultilocus) ]
#	Tdem_3 = [ Tdem_3[i]/Na[i] for i in range(nMultilocus) ]
#	Tsmall_12 = [ Tsmall_12[i]/Na[i] for i in range(nMultilocus) ]
#	Tsmall_13 = [ Tsmall_13[i]/Na[i] for i in range(nMultilocus) ]
	
#	Na = [ Na[i]/Na[i] for i in range(nMultilocus) ]
